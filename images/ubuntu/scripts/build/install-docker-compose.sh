...
if is_arm64; then
    ...
    binary_path=$(download_with_retry "https://github.com/docker/compose/releases/download/v2.23.3/docker-compose-linux-aarch64")

    # Supply chain security - Docker Compose v2
    external_hash="71f38f0923b8a9b80ad02c823ec3207d94677547aa5c618ca41b81d29fe6b9d9"
else
