...
# Downgrade kernel from 6.17 (shipped with 24.04.4) to 6.14 to keep
# parity with the previous image.
# Expects KERNEL_SUFFIX to be set (e.g. "azure" or "aws").

: "${KERNEL_SUFFIX:?KERNEL_SUFFIX must be set (e.g. azure or aws)}"

TARGET_KERNEL="6.14.0-1017-${KERNEL_SUFFIX}"
...
# Verify the new kernel is actually installed before purging anything
