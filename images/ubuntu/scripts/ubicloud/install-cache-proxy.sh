...
if is_x64; then
  download_url="https://pub-dd18084e939b4f87816c08c17faeb647.r2.dev/cache-proxy-linux-x64.tar.gz"
elif is_arm64; then
  download_url="https://pub-dd18084e939b4f87816c08c17faeb647.r2.dev/cache-proxy-linux-arm64.tar.gz"
else
